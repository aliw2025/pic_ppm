                 ...
                 <div class="card-body">
                     ...
                     <div class="row">
                         ...
                         <div class="col-4">
                             ...
                             <input @if(isset($asset)) value="{{$asset->equipment_category_name}}"  @endif name="equipment_category_name" placeholder="Name" type="text"
                                 class="form-control">
                         </div>
                         <div class="col-4">
                             <label class="mt-1 form-label">Equipment Type</label>
                             <input @if(isset($asset)) value="{{$asset->equipment_type}}" @endif name="equipment_type" placeholder="Equipment Type" type="text"
                                 class="form-control">
                         </div>
                         <div class="col-4">
                         ...
                         <div class="col-4">
                             ...
                             <input  @if(isset($asset)) value="{{$asset->serial_number}}" @endif name="serial_number" placeholder="Serial number" type="text"
                                 class="form-control">
                         </div>
                         <div class="col-4">
                         ...
                         <div class="col-4">
                             ...
                             <input @if(isset($asset)) value="{{$asset->equipment_sequence_number}}" @endif	name="equipment_seq_number" placeholder="Equipment Sequence #" type="text"
                                 class="form-control">
                         </div>
                         <div class="col-4">
                             <label class="mt-1 form-label"> Manufacture Date</label>
                             <input   @if(isset($asset)) value="{{$asset->manufacture_date}}" @endif  name="manufacture_date" placeholder="Manufacture Date" type="date"
                                 class="form-control">
                         </div>
                         <div class="col-4">
                             <label class="mt-1 form-label"> Installation Date</label>
                             <input   @if(isset($asset)) value="{{$asset->installation_date	}}" @endif  name="installation_date" placeholder=" Installation Date" type="date"
                                 class="form-control">
                         </div>
                         <div class="col-4">
                 ...
                 <div class="card-body">
                     <div class="row">
                         ...
                         <div class="col-3">
                             ...
                             <input  @if(isset($asset)) value="{{$asset->sub_section}}" @endif name="sub_section" placeholder="Sub Section" type="text"
                                 class="form-control">
                         </div>
                     </div>
                     <div class="row mt-1">
                         <div class="col-3">
                             ...
                             <input  @if(isset($asset)) value="{{$asset->custodian_name}}" @endif name="custodian_name" placeholder="Custodian Name" type="text"
                                 class="form-control">
                         </div>
                         <div class="col-3">
                             <label class="mt-1 form-label">Office Extention</label>
                             <input  @if(isset($asset)) value="{{$asset->office_extention}}" @endif  name="custodian_ofc_ext" placeholder="Office Extention" type="text"
                                 class="form-control">
                         </div>
                         <div class="col-3">
                             <label class="mt-1 form-label">Mobile</label>
                             <input  @if(isset($asset)) value="{{$asset->mobile}}" @endif   name="custodian_mobile" placeholder="Mobile" type="text"
                                 class="form-control">
                         </div>
                         <div class="col-3">
